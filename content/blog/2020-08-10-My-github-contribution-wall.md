...
![别人的 Github 贡献墙照片](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(1).jpg)
...
![我 Github 设置的邮箱](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(2).jpg)

要改邮箱的话，得看之前提交的记录里，邮箱都写得是什么。可以在 git 命令行用 `git log` 查看提交记录中的提交者邮箱信息。

![git log 命令行截图](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(3).jpg)

显然这样看的效率太低了，我是用 [sourcetree](https://www.sourcetreeapp.com/) 查看的，在 sourcetree 中查看提交者信息很方便：

![sourcetree 的截图](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(4).jpg)
...
![git 命令行的截图](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(5).jpg)
...
![@zsdycs 在 GitHub 上的活动汇总](https://lipk.oss-ap-southeast-1.aliyuncs.com/images/my-github-contribution-wall(6).jpg)
