...
要注意的是，这段代码再使用后会有一个提示信息，然后几秒过后才会执行。执行时间与代码库的提交次数成正比，执行完后，使用 `git push --force --tags origin 'refs/heads/*'` 来提交更改。更改提交后，要 `git pull --tags --rebase origin master` 来以 rebase 的方式来拉一下远程库的代码。

## 面壁感概

面对整理好的绿墙，她详细记录了我与她之间的点点滴滴。

第一次尝试提交，第一个绿点出现。那时是 2018 年的 10 月 30 号，我如今仍然记得那时是实习，被外派到现场客开，没多久苏州到了冬天，我骑着电动车在学校与清源华衍水务之间，雨冰冰凉，风吹过头盔呜呜叫。

过了好了一阵子，我开始写个人网站，但是因为有实习工作而且懒得缘故，断断续续的。后来我辞职了，全身心投入到毕业设计中去。大概有两个月，那段时间，密密麻麻的，竟然可是有连续两个星期都有提交的情况了。4 月 9 号，一定是非常开心的一天，因为我的毕业设计作了最后一个提交。
