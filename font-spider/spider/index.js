    ...
    cssStyleRules.forEach(function (cssStyleRule) {
      ...
      webFonts.forEach(function (webFont) {
        ...
        if (webFont.matchStyle(style)) {
          ...
          style.content &&
          !WebFont.getComputedFontFamilys(style).length
        ) {
    ...
    console.log(
      ...
      Object.keys(message)
        .map(function (key) {
          ...
          return (
            JSON.stringify(key) + ': ' + colors.green(JSON.stringify(value))
          );
        })
        .join(', '),
      '}',
